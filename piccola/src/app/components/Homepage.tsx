...
export default async function Homepage(){
    ...
    return(
        <section className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
        <div className="mb-8 flex flex-wrap justify-between md:mb-16">  
            <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
                <h1 className="mb-4 text-4xl font-bold text-black sm:text-5xl md:mb-8 md:text-6xl">
                    Discover Your Style with Piccola    
                </h1>
                <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
                    Explore the latest trends in fashion with Piccola. From casual wear to formal attire, we have everything you need to express your unique style.
                </p>
